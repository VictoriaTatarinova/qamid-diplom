...
public class MainScreen {
    ...
    public static ViewInteraction titleOfFirstNews = onView(MainHelper.withIndex(withId(R.id.news_item_title_text_view), 0));
    public static ViewInteraction titleOfThirdNews = onView(MainHelper.withIndex(withId(R.id.news_item_title_text_view), 2));
    public static ViewInteraction dateOfFirstNews = onView(MainHelper.withIndex(withId(R.id.news_item_date_text_view), 0));
    ...
    public static ViewInteraction descriptionOfFirstClaim = onView(MainHelper.withIndex(withId(R.id.description_material_text_view), 0));
    public static ViewInteraction executorOfFirstClaim = onView(MainHelper.withIndex(withId(R.id.executor_name_material_text_view), 0));
    public static ViewInteraction planeDateOfFirstClaim = onView(MainHelper.withIndex(withId(R.id.plan_date_material_text_view), 0));
    public static ViewInteraction planeTimeOfFirstClaim = onView(MainHelper.withIndex(withId(R.id.plan_time_material_text_view), 0));
}
